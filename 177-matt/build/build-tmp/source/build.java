...
public void setup(){
  ...
  for (int j = 0; j < 1024; j++) {
    ...
    for(int i=0;i<mesh.numberOfVertices();i++){
     vertices[i][0]*=random(12.2f,20)+.2f*cos(HALF_PI/100*i+HALF_PI); 
     vertices[i][1]*=random(12.2f,20)+.2f*sin(HALF_PI/100*i+QUARTER_PI);
  ...
  public void draw(){
    ...
    render.drawFaces(modifiedMesh*2.0f);
