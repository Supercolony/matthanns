...
public void setup(){
  ...
  for (int j = 0; j < 1024; j++) {
    ...
    creator.setUSize(random(100*cos(frameCount*PI/100),200*cos(frameCount*PI/100)));// size of grid in U direction
    creator.setVSize(random(100*cos(frameCount*PI/100),200*cos(frameCount*PI/100)));// size of grid in V direction
    ...
    for(int i=0;i<mesh.numberOfVertices();i++){
     vertices[i][0]*=random(12.2f,cos(frameCount*PI/100))+2.2f*cos(HALF_PI/100*i+HALF_PI+noise(200.5f,200.5f));
     vertices[i][1]*=random(12.2f,20)+2.2f*sin(HALF_PI/100*i+QUARTER_PI+noise(200.5f,200.5f));
     vertices[i][2]*=random(100,200)+1.2f*cos(HALF_PI/500*i+QUARTER_PI+noise(20.5f,1000.5f));
    }
    ...
    creator2.setUSize(40*cos(frameCount*PI/100));// size of grid in U direction
    creator2.setVSize(50*cos(frameCount*PI/100));// size of grid in V direction
    ...
    //Do something with the vertices, x, y, z
    for(int i=0;i<mesh.numberOfVertices();i++){
     vertices2[i][0]*=random(12.2f,20)+20.2f*cos(HALF_PI/100*i+HALF_PI+noise(200.5f,200.5f));
     vertices2[i][1]*=random(12.2f,20)+2.2f*sin(HALF_PI/100*i+QUARTER_PI+noise(200.5f,200.5f));
     vertices2[i][2]*=random(10*cos(frameCount*PI/100),1000)+10.2f*cos(HALF_PI/500*i+QUARTER_PI+noise(20.5f,1000.5f));
    }
  ...
  public void draw(){
    lights();
    pushMatrix();
    translate(500,10.5f*cos(frameCount*PI/90),depth);
    fill(232, 181, 153);
    scale(1.2f*cos(frameCount*PI/90));
    ...
    pushMatrix();
    translate(100,10.5f*cos(frameCount*PI/90),depth);
    fill(54, 79, 175);
    scale(1.2f*cos(frameCount*PI/100));
    ...
    translate(500,10.5f*cos(frameCount*PI/90),depth);
    fill(228, 123, 75);
    scale(1.2f*cos(frameCount*PI/120));
    rotateZ(frameCount*PI/50);
    rotateX(frameCount*PI/50);
    stroke(36, 53, 117);
    render.drawFaces(modifiedMesh);
