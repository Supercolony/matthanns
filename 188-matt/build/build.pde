...
void setup(){
  ...
  for (int j = 0; j < 1024; j++) {
    ...
    for(int i=0;i<mesh.numberOfVertices();i++){
     ...
     vertices[i][2]*=random(100,1000)+10.2*cos(HALF_PI/500*i+QUARTER_PI+noise(20.5,1000.5));
    }
  ...
  void draw(){
    ...
    rotateY(frameCount*PI/100/PI*noise(20.5,1000.5));
    rotateX(frameCount*PI/100/PI*noise(20.5,1000.5));
    rotateX(frameCount*PI/100/PI*noise(20.5,1000.5));
    rotateZ(frameCount*PI/100/PI*noise(20.5,1000.5));
    fill(241,85,38,10);
