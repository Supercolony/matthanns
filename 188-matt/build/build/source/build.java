...
public void setup(){
  ...
  for (int j = 0; j < 1024; j++) {
    ...
    for(int i=0;i<mesh.numberOfVertices();i++){
     ...
     vertices[i][2]*=random(100,1000)+10.2f*cos(HALF_PI/500*i+QUARTER_PI+noise(20.5f,1000.5f));
    }
  ...
  public void draw(){
    ...
    rotateY(frameCount*PI/100/PI*noise(20.5f,1000.5f));
    rotateX(frameCount*PI/100/PI*noise(20.5f,1000.5f));
    rotateX(frameCount*PI/100/PI*noise(20.5f,1000.5f));
    rotateZ(frameCount*PI/100/PI*noise(20.5f,1000.5f));
    fill(241,85,38,10);
    stroke(255,205,101,80);
