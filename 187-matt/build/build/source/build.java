...
public void setup(){
  ...
  for (int j = 0; j < 1024; j++) {
    ...
    for(int i=0;i<mesh.numberOfVertices();i++){
     vertices[i][0]*=random(12.2f,100)+.2f*cos(HALF_PI/100*i+HALF_PI+noise(200.5f,200.5f));
     vertices[i][1]*=random(12.2f,100)+.2f*sin(HALF_PI/100*i+QUARTER_PI+noise(200.5f,200.5f));
     vertices[i][2]*=random(100,2000-mouseY)+1.2f*cos(HALF_PI/500*i+QUARTER_PI+noise(20.5f,1000.5f));
    }
  ...
  public void draw(){
    ...
    rotateY(frameCount*PI/500/HALF_PI*noise(20.5f,1000.5f));
    rotateX(frameCount*PI/500/HALF_PI*noise(20.5f,1000.5f));
    rotateY(frameCount*PI/500/HALF_PI*noise(20.5f,1000.5f));
    rotateZ(frameCount*PI/500/HALF_PI*noise(20.5f,1000.5f));
    fill(143,214,220,40);
    stroke(21,48,77,100);
