...
public void draw() {
  ...
  pushMatrix();
  translate(500, 1000*cos(frameCount*PI/2000), 0);
  rotateY(10*cos(frameCount*PI/2000));
  rotateX(10*cos(frameCount*PI/2000));
  rotateZ(10*cos(frameCount*PI/2000));
  rotateZ(10*cos(frameCount*PI/2000));
  fill(230, 184, 53,30);
  noStroke();
  render.drawFaces(mesh);
...
public void createMesh() {
  ...
  mesh=new HE_Mesh(new HEC_FromFrame().setFrame(mesh).setMaximumStrutLength(10*noise(100.5f,1000.5f)));
}
